...
export type ButtonProps = JSX.HtmlButtonTag & VariantProps<typeof buttonVariants>;

export function Button({ variant = "default", class: className, size, ...props }: ButtonProps) {
	return <button class={cn(buttonVariants({ variant, size, className }))} {...props} />;
}
